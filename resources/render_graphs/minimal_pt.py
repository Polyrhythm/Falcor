...
def render_graph_minimal_tracer():
    g = RenderGraph('minimal_tracer')
    ...
    g.addEdge('ToneMapper', 'PixelInspectorPass')
...
minimal_tracer = render_graph_minimal_tracer()
try: m.addGraph(minimal_tracer)
